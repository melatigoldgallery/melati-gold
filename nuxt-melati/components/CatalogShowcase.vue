...
<template>
  <section
    id="produk"
    class="relative bg-gradient-to-b from-cream via-white to-cream py-10 md:py-14 overflow-hidden"
  >
    <div class="container mx-auto max-w-7xl px-4">
      ...
      <div v-if="loading" class="text-center py-12">
        <div
          class="inline-block h-12 w-12 animate-spin rounded-full border-b-2 border-yellow-600"
        ></div>
                  ...
                  >
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-4 sm:p-5">
                      ...
                      <p
                        ...
                        class="mt-2 text-sm text-white/90 line-clamp-2"
                      >
