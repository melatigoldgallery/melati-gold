  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
      ...
      <form @submit.prevent="handleSubmit" class="p-4 sm:p-6 space-y-3 sm:space-y-4">
        ...
        <!-- Subtitle -->
        <div>
          <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Subtitle</label>
          <input
        ...
        <div>
          <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Features</label>
          <textarea
            v-model="featuresText"
            rows="4"
            placeholder="Enter each feature on a new line:&#10;Konsultasi gratis&#10;Design custom sesuai keinginan&#10;Revisi unlimited"
            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 font-mono"
          ></textarea>
        ...
        <!-- Duration -->
        <div>
          <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Duration</label>
          <input
        ...
        <!-- Price Info -->
        <div>
          <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Price Info</label>
          <input
        ...
        <!-- Display Order -->
        <div>
          <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Display Order</label>
          <input
        ...
        <div class="flex items-center">
          ...
          <label for="service_is_active" class="text-xs sm:text-sm text-gray-700">Active (visible to users)</label>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 sm:pt-4">
          ...
          <button
            type="button"
            @click="$emit('close')"
            class="w-full sm:w-auto px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm sm:text-base"
          >
            Cancel
          </button>
        </div>
