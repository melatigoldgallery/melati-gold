              ...
              >
                ...
                >
                  <NuxtLink
                    ...
                    class="group relative block w-full overflow-hidden rounded-xl card-shadow hover:card-shadow-hover transition-all duration-300 hover:-translate-y-1 aspect-[3/4]"
                  >
                    <img
